...
NextPlayerButton.Position = UDim2.new(0, 10, 0.4, -20)  -- Di chuyển lên trên một chút
...
-- Khi người dùng nhấp vào nút "Next Player", gọi hàm findtarget() và hiển thị thông báo
NextPlayerButton.MouseButton1Down:Connect(function()
    ...
    -- Hiển thị thông báo với số lần nhấp
    game.StarterGui:SetCore(
        "SendNotification",
        {
            Title = "Auto Bounty",
            Text = "Đang Tìm Người Chơi: " .. clickCount,  -- Hiển thị số lần nhấp
            Duration = 3  -- Thời gian hiển thị thông báo (3 giây)
        }
    )
end)
