...
local function updateUI()
	...
	playerGui.Fragments.Text = "kitty"
...
v8.Page9:AddButton({
	...
	Callback = function()
		...
		elseif game:GetService("Players").LocalPlayer.Data.Race.Value == "Cyb" then
...
local crackedhub = {
	...
	["this is meo meo"] = Instance.new("ScreenGui"),
...
crackedhub["this is meo meo lazy"]["Parent"] = game:GetService("Players").LocalPlayer:FindFirstChild("PlayerGui")

crackedhub["meo"]["Name"] = 'meoo'

crackedhub["hmeoooo"]["DisplayOrder"] = 1



crackedhub["Main"]["Parent"] = crackedhub["meooooooo"]
...
crackedhub["Sectiontitle"]["Text"] = 'kity'
...
crackedhub["discordTitle"]["Text"] = 'kityy'
...
crackedhub["ImageLabel"].MouseButton1Click:Connect(function()
	...
	game.Players.LocalPlayer.PlayerGui["kiiity"]:Destroy()

end)

if true then
	if true then
		game.Players.LocalPlayer.PlayerGui["kizt"]:Destroy()
