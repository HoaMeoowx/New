...
game.StarterGui:SetCore(
	...
	Start Auto Farm = true, getgenv().Settings = {


	Start Auto Farm = true,
...
local function v0_()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("TurboLite") then

			makefolder("TurboLite")

		end

		if not isfolder("TurboLite/Blox Fruits/") then

			makefolder("TurboLite/Blox Fruits/")

		end

		if not isfile("Turbo Lite/Blox Fruits/TurboLite.json") then

			writefile("TurboLite/Blox Fruits/TurboLite.json", game:GetService("HttpService"):JSONEncode(getgenv().Settings))

		else

			local v124 = game:GetService("HttpService"):JSONDecode(readfile("TurboLite/Blox Fruits/TurboLite.json"))
...
local function v1_()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfile("TurboLite/Blox Fruits/TurboLite.json") then

			v0_()

		else

			local v127 = game:GetService("HttpService"):JSONDecode(readfile("TurboLite/Blox Fruits/TurboLite.json"))
			...
			writefile("TurboLite/Blox Fruits/TurboLite.json", game:GetService("HttpService"):JSONEncode(v128))
